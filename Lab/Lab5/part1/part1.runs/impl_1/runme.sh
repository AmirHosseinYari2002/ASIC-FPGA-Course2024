...
HD_PWD='E:/University/Semester 8/FPGA/Lab/Lab5/part1/part1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sign_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sign_adder.tcl -notrace
