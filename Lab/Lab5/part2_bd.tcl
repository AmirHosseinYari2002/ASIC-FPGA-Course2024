...
################################################################
# This is a generated script based on design: part2
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set KEY [ create_bd_port -dir I -from 1 -to 0 KEY ]
  ...
  connect_bd_net -net ALU_0_result [get_bd_pins ALU_0/result] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net XOR_0_result [get_bd_pins ALU_0/op] [get_bd_pins XOR_0/result]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins XOR_0/operand1] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins ALU_0/operand2] [get_bd_pins axi_gpio_1/gpio2_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins ALU_0/operand1] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net operand2_0_1 [get_bd_ports KEY] [get_bd_pins XOR_0/operand2]
