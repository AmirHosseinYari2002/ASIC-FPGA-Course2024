...
HD_PWD='E:/University/Semester 8/FPGA/Lab/Lab5/part1/part1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sign_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sign_adder.tcl
